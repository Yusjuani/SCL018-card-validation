...
validar.addEventListener("click", () => {
  ...
  mostrarDigitos.innerHTML =
    "El número de su tarjeta es : " + validator.maskify(inputValue); //mostrar js en html
});
